	...
	constructor() {
		...
		this.translation = {
			'en':{
				...
				'USER_ENERGY_PRICE_SAVED_OK':'New price saved OK.',
				...
				'USER_HEATING_FEEDBACK_PROMPT':'Give feedback: how do you feel about the apartment temperature today?',
			...
			'fi':{
				...
				'USER_ENERGY_PRICE_SAVED_OK':'Uusi hinta talletettu OK.',
				...
				'USER_HEATING_FEEDBACK_PROMPT':'Anna palautetta: miltä asunnon lämpötila tuntuu tänään?',
