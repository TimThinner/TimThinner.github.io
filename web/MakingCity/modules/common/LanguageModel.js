	...
	constructor() {
		...
		this.translation = {
			'en':{
				...
				'USER_ELECTRICITY_CHART_TITLE_30_DAYS':'Electricity consumption 30 days',
			...
			'fi':{
				...
				'USER_ELECTRICITY_CHART_TITLE_30_DAYS':'Sähkönkulutus 30 päivää',
