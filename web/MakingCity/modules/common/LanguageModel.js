	...
	constructor() {
		...
		this.translation = {
			'en':{
				...
				'GRID_TITLE':'The Grid Page',
				'GRID_DESCRIPTION':'Here you will find more information about the aggregated load (from Fingrid open data).',
			...
			'fi':{
				...
				'GRID_TITLE':'Sähköverkko',
				'GRID_DESCRIPTION':'Täältä löytyy lisätietoa sähköverkon kuormituksesta (Fingridin avoin data).',
