	...
	constructor() {
		...
		this.translation = {
			'en':{
				...
				'USER_INFO':'User Info',
				'USER_DESCRIPTION':'Here you will find all user related information and settings.',
				'USER_LOGOUT':'LOGOUT',
				'USERHOME_TITLE':'Home',
				'USERHOME_DESCRIPTION':'Here you will find values for your:',
				'USERHOME_BULLET_1':'- electricity consumption',
				'USERHOME_BULLET_2':'- heating consumption',
				'USERHOME_BULLET_3':'- water consumption',
			...
			'fi':{
				...
				'USER_DESCRIPTION':'Täältä löytyvät kaikki käyttäjää koskevat tiedot ja asetukset.',
				'USER_LOGOUT':'KIRJAUDU ULOS',
				'USERHOME_TITLE':'Koti',
				'USERHOME_DESCRIPTION':'Tälla sivulla näytetään sinun:',
				'USERHOME_BULLET_1':'- sähkönkulutus',
				'USERHOME_BULLET_2':'- lämmityskulut',
				'USERHOME_BULLET_3':'- vedenkulutus',
				'DISTRICT_A_LABEL':'S-Arina',
				'DISTRICT_B_LABEL':'Sivakka 1',
				'DISTRICT_C_LABEL':'Sivakka 2',
				'DISTRICT_D_LABEL':'YIT 1',
