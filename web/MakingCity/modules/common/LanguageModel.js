	...
	constructor() {
		...
		this.translation = {
			'en':{
				...
				'GRID_PAGE_DESCRIPTION':'Here you will find more information about the aggregated load (from Fingrid open data). Values are updated once every 3 minutes, except solar energy forecast which is updated once per hour.',
			...
			'fi':{
				...
				'GRID_PAGE_DESCRIPTION':'Täältä löytyy lisätietoa sähköverkon kuormituksesta (Fingridin avoin data). Kaikki lukuarvot päivittyvät 3 minuutin välein, paitsi aurinkoenergian ennuste joka päivittyy kerran tunnissa.',
