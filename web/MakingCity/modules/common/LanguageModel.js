	...
	constructor() {
		...
		this.translation = {
			'en':{
				...
				'USER_ELECTRICITY_TITLE':'Electricity consumption',
			...
			'fi':{
				...
				'USER_ELECTRICITY_DESCRIPTION':'Täältä löytyvät tiedot asuntokohtaisesta sähkönkulutuksesta eri aikaväleillä.',
				'DISTRICT_A_LABEL':'S-Arina',
				'DISTRICT_B_LABEL':'Sivakka 1',
				'DISTRICT_C_LABEL':'Sivakka 2',
				'DISTRICT_D_LABEL':'YIT 1',
