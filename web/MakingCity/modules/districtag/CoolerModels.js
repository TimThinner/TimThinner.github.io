...
*/
export class Cooler113Model extends FeedModel {
	
	constructor(options) {
		super(options);
	}
}
export class Cooler112Model extends FeedModel {
...
export class CoolerKLPowerModel extends FeedModel {
	
	constructor(options) {
		super(options);
	}
}
export class CoolerCoolingPowerModel extends FeedModel {
