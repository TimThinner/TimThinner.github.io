	...
	constructor() {
		...
		this.translation = {
			...
			'fi':{
				...
				'GRID_PAGE_CLOCK_COLORS':'Värikoodaus: Vihreä = päästöt ja hinta pienemmät. Oranssi = päästöt ja hinta sama. Punainen = päästöt ja hinta suuremmat',
