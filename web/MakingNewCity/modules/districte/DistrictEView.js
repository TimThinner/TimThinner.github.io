	...
	*/
	...
	addSVGEventHandlers() {
		...
		if (svgObject) {
			...
			const targetB = svgObject.getElementById('target-e-b');
			...
			const targetG = svgObject.getElementById('target-e-g');
	...
	localizeSVGTexts() {
		...
		if (svgObject) {
			...
			this.fillSVGTextElement(svgObject, 'de-grid-title', localized_grid_title);
			this.fillSVGTextElement(svgObject, 'de-solar-title', localized_solar_title);
			this.fillSVGTextElement(svgObject, 'de-apartments-title', localized_apartments_title);
			this.fillSVGTextElement(svgObject, 'de-other-title-1', localized_other_title_1);
			this.fillSVGTextElement(svgObject, 'de-other-title-2', localized_other_title_2);
			this.fillSVGTextElement(svgObject, 'de-other-title-3', localized_other_title_3);
			this.fillSVGTextElement(svgObject, 'de-heating-system-title-1', localized_heating_system_title_1);
			this.fillSVGTextElement(svgObject, 'de-heating-system-title-2', localized_heating_system_title_2);
			this.fillSVGTextElement(svgObject, 'de-exthaus-air-reco-title-1', localized_exthaus_air_reco_title_1);
			this.fillSVGTextElement(svgObject, 'de-exthaus-air-reco-title-2', localized_exthaus_air_reco_title_2);
			this.fillSVGTextElement(svgObject, 'de-dhn-title-1', localized_dhn_title_1);
			this.fillSVGTextElement(svgObject, 'de-dhn-title-2', localized_dhn_title_2);
			this.fillSVGTextElement(svgObject, 'de-dhn-title-3', localized_dhn_title_3);
			this.fillSVGTextElement(svgObject, 'de-heating-dev-title-1', localized_heating_dev_title_1);
			this.fillSVGTextElement(svgObject, 'de-heating-dev-title-2', localized_heating_dev_title_2);
			this.fillSVGTextElement(svgObject, 'de-hot-water-title-1', localized_hot_water_title_1);
			this.fillSVGTextElement(svgObject, 'de-hot-water-title-2', localized_hot_water_title_2);
		}
	}
