	...
	constructor() {
		...
		this.translation = {
			'en':{
				...
				'BUILDING_CO2_DESCRIPTION_3':'Lower chart displays CO<sub>2</sub> emissions for electricity and district heating.',
			...
			'fi':{
				...
				'BUILDING_CO2_DESCRIPTION_3':'Alemmassa kuvaajassa on sähkön ja kaukolämmön CO<sub>2</sub> päästöt.',
