...
export default class UserConsentView extends View {
	...
	render() {
			...
			'<div class="row">'+
				...
				'<div class="col s12">'+
					'<div class="input-field col s12">'+
						'<p><label><input type="checkbox" class="filled-in" id="consent-one" /><span style="color:#000;">'+localized_string_consent_check_a+'</span></label></p>'+
					'</div>'+
				'</div>'+
				'<div class="col s12">'+
					'<div class="input-field col s12">'+
						'<p><label><input type="checkbox" class="filled-in" id="consent-two" /><span style="color:#000;">'+localized_string_consent_check_b+'</span></label></p>'+
					'</div>'+
				'</div>'+
				'<div class="col s12">'+
					'<div class="col s12">'+
		...
		Check whether we are logged in or is this shown during SIGN-UP process:
		
		if (this.models['UserModel'].consent_one === true) {
			$('#consent-one').attr('checked','checked');
		}
		if (this.models['UserModel'].consent_two === true) {
