	...
	constructor() {
		...
		this.translation = {
			'en':{
				...
				'FEEDBACK_ACTIVE_PERIOD_DATE':'Date:',
				'FEEDBACK_ACTIVE_PERIOD_TIME':'Time:',
				...
				'BUILDING_CO2_TITLE':'Building CO2 carbon footprint',
				'BUILDING_CO2_DESCRIPTION_1':'Upper chart shows your buildings average carbon footprint per resident.',
				'BUILDING_CO2_DESCRIPTION_2':'The number of residents used in calculation is ',
				'BUILDING_CO2_DESCRIPTION_3':'Lower chart displays CO2 emissions for electricity and district heating.',
				...
				'BUILDING_FLEXIBILITY_PRICE':'Cost',
				...
				'BUILDING_OPTIMIZATION_DECREASE':'decrease',
				'BUILDING_OPTIMIZATION_INCREASE':'increase',
				...
				'USER_HEATING_CO2_NOW_TITLE':'CO2 (ppm)',
				...
				'FLEXIBILITY_OPTIONS_DESCRIPTION':'The savings are calculated over specified timerange. Here you can select the timerange:',
				...
				'GDPR_CHAPTER_2AAA':'Nimi: Satu Streng',
				'GDPR_CHAPTER_2AAB':'',
				'GDPR_CHAPTER_2AAC':'Sähköposti: <a href="mailto:tietosuoja@vtt.fi">tietosuoja@vtt.fi</a> (tietosuojavastaava, tietoturvapäällikkö, HR ja lakimies)',
			...
			'fi':{
				...
				'FEEDBACK_ACTIVE_PERIOD':'Palaute kohdistuu oletusarvoisesti nykyiseen ajanhetkeen, mutta voit vaihtaa päivämäärän ja/tai kellonajan.',
				'FEEDBACK_ACTIVE_PERIOD_DATE':'Päivämäärä:',
				'FEEDBACK_ACTIVE_PERIOD_TIME':'Kellonaika:',
				...
				'BUILDING_CO2_DESCRIPTION_1':'Ylemmässä kuvaajassa on asuinrakennuksesi hiilijalanjälki (keskiarvo) per asukas.',
				'BUILDING_CO2_DESCRIPTION_2':'Laskennassa käytetty asukkaiden lukumäärä on ',
				'BUILDING_CO2_DESCRIPTION_3':'Alemmassa kuvaajassa on sähkön ja kaukolämmön CO2 päästöt.',
				...
				'BUILDING_FLEXIBILITY_TITLE':'Rakennuksen kulutusjousto',
