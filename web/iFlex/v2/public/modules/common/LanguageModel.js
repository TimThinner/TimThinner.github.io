	...
	constructor() {
		...
		this.translation = {
			'en':{
				...
				'BUILDING_FLEXIBILITY_DESCRIPTION':'Building total electricity consumption for the last 30 days.',
			...
			'fi':{
				...
				'BUILDING_FLEXIBILITY_DESCRIPTION':'Rakennuksen sähkön kokonaiskulutus, viimeiset 30 päivää.',
